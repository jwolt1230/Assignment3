...
$.getJSON( "geojson/Facilities.geojson", function( data ) {
    ...
    var pubLibrary = data;
        //can't get this conditional to work to set the value of facilities type to public library branch
        /*var value = feature.properties.ft_decode;
        if (value == "Public Library - Branch"){
    ...
    var pubLibraryPointToLayer = function (feature, latlng) {
        /*var value = feature.properties.facname;
        var fillColor = null;*/
        var pubLibraryMarker = L.circle(latlng, 75, {
            /*if(value = "Public Library - Branch"){*/
                stroke: false,
                fillColor: '#08519c',
                fillOpacity: 1
